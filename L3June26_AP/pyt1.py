"""
pyt1.py - Simple interactive chat client for Ollama.
Uses LangChain's ChatOllama to send user prompts with configurable
temperature and response length limits.
"""
